...
model1 = naiveBayes(output ~ make + model, data = t3_dat)
...
### DECISON TREE : 
```{r}
model2 = rpart(speeding ~ make+model+geolocation+location, data=t3_dat)
...
model3 = rpart(speeding ~ make+model+location+color, data=t3_dat)
...
barplot(model2$variable.importance)
```
